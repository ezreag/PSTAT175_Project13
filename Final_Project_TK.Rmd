...
CPH.3 <-coxph(formula = stagSurv ~ age+ind+prof+traffic+greywage+way+
                  extraversion+independ+selfcontrol+anxiety+novator+
                  ex3+id3+sc3+ax3+nv3, data = turnover)
CPH.5 <-coxph(formula = stagSurv ~ age+ind+prof+traffic+greywage+way+
                  extraversion+independ+selfcontrol+anxiety+novator+
                  ex5+id5+sc5+ax5+nv5, data = turnover)
CPH.7 <-coxph(formula = stagSurv ~ age+ind+prof+traffic+greywage+way+
                  extraversion+independ+selfcontrol+anxiety+novator+
                  ex7+id7+sc7+ax7+nv7, data = turnover)
